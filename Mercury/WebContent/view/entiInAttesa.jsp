  ...
  <table border="1" style="width:100%">
	...
	<c:forEach var="j" items="${sessionScope.enti_attesa}">
		<tr>
			...
			<td style="width:140px" align="center"><button style="width:65px" onclick="location.href='../ControllerAdmin?param=mod_stat&id_evento=${j.id_ente}&id_status=2'">Approva</button><button style="width:65px" onclick="location.href='../ControllerAdmin?param=mod_stat&id_evento=${j.id_ente}&id_status=3'">Rifiuta</button></td>
