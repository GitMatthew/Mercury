...
<body id="myPage" data-spy="scroll" data-target=".navbar"
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right"
				...
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="#">AREA ENTE <span class="caret"></span></a>
	...
	<div id="band" class="container text-center">
		...
		<form method="post" action="">
			...
			<div class="row">
				<div class="col-sm-2">
					<a href="#cat" data-toggle="collapse"> categoria </a>
				...
				<div class="col-sm-2">
					<a href="#reg" data-toggle="collapse"> regione </a>
				...
				<div class="col-sm-2">
					<a href="#pro" data-toggle="collapse"> provincia </a>
				...
				<div class="col-sm-2">
					<a href="#com" data-toggle="collapse"> comune </a>
					<div id="com" class="collapse">
						<p>
							<input width="200px" placeholder="scegli ">
						</p>
					</div>
				</div>
				<div class="col-sm-2">
					<a href="#din" data-toggle="collapse"> data inizio </a>
				...
				<div class="col-sm-2">
					<a href="#dfine" data-toggle="collapse"> data fineaaag </a>
