...
public interface EventoUtility {
    ...
    public String EVENTI_ENTE = "SELECT distinct e.url_img_evento,  e.nome_evento , e.descrizione, cat.nome_categoria , com.nome_comune , e.data_inizio, e.data_fine , stat.nome_status , enti.nome_ente \r\n" 
