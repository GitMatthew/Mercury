...
public interface AdminUtility {
	...
	public static String GET_ALL_ENTS="SELECT id_ente,id_status,nome_status,nome_ente,descrizione_ente FROM enti inenr join status on enti.id_status=status.id_status WHERE id_status=2 || id_status=3 || id_status=4 order by id_status";
