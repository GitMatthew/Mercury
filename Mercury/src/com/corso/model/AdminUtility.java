...
public interface AdminUtility {
	...
	public static String DELETE_CAT = "DELETE categorie.* FROM categorie WHERE id_categoria=?";
	public static String GET_EVENTS_PENDING = "SELECT url_img_evento,url_sito_evento,id_evento,nome_evento,descrizione,data_inizio,data_fine FROM eventi WHERE data_inizio >= now() and id_status=1 order by eventi.data_inizio";
	public static String GET_ENTS_PENDING = "SELECT url_sito_ente,id_ente,nome_ente,descrizione_ente,email_ente FROM enti WHERE id_status=1";
