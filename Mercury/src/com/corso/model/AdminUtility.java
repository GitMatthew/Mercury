...
public interface AdminUtility {
	...
	public static String GET_EVENTS_PENDING = "SELECT url_img_evento,id_evento,nome_evento,descrizione,data_inizio,data_fine FROM eventi WHERE data_inizio >= now() and id_status=1 order by eventi.data_inizio";
